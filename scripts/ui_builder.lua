...
-- Generates clean, responsive UI templates (Notification Toast, Floating Button, Card Container) inside PlayerGui.
...
-- Close Button for UI Builder
local closeBuilder = Instance.new("TextButton")
closeBuilder.Size = UDim2.fromOffset(26, 26)
closeBuilder.Position = UDim2.new(1, -32, 0, 7)
closeBuilder.BackgroundColor3 = Color3.fromRGB(200, 50, 50)
closeBuilder.Text = "X"
closeBuilder.TextColor3 = Color3.new(1, 1, 1)
closeBuilder.Font = Enum.Font.GothamBold
closeBuilder.TextSize = 10
closeBuilder.Parent = window

Instance.new("UICorner", closeBuilder).CornerRadius = UDim.new(0, 6)
closeBuilder.Activated:Connect(function()
    screenGui:Destroy()
end)
